...
=end
  ...
  def test_supported_countries_are_inherited
    assert_equal AuthorizeNetGateway.supported_countries, EprocessingNetworkGateway.supported_countries
  end

  def test_supported_card_types_are_inherited
    assert_equal AuthorizeNetGateway.supported_cardtypes, EprocessingNetworkGateway.supported_cardtypes
  end
